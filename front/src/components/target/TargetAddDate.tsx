import {Button, Center, Checkbox, CloseButton, createStyles, Divider, Popover, Stack, Text} from "@mantine/core";
...
export default function TargetAddDate() {
    ...
    const handleAddDatePeriod = (startDate, timeLength) => {
    ...
    >
        ...
        >
            ...
            <Stack spacing={10}>
                ...
                />
                <Button
                    onClick={() => handleAddDatePeriod(startDate, timeLength)}
                >
                    Сохранить
                </Button>
                <Button
